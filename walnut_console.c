 ...
 * walnut_console.c
 *
 * Routines supporting consoles on pseudo terminals within a walnut
 *
...
static void walnut_console_rw_loop(int ptm, const char *cmd, const char *args)
{
	fd_set rfds;
	fd_set efds;
...
int open_walnut_console(int ptm, const char *cmd, const char *args)
{
	...
	walnut_console_rw_loop(ptm, cmd, args);
